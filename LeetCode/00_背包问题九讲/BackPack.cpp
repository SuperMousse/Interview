...
f[4]  = max(f[0, 4], f[0, 0]+V_1) = max(0, 0+6) = 6
f[5]  = max(f[0, 5], f[0, 1]+V_1) = max(0, 0+6) = 6
f[6]  = max(f[0, 6], f[0, 2]+V_1) = max(0, 0+6) = 6
f[7]  = max(f[0, 7], f[0, 3]+V_1) = max(0, 0+6) = 6
f[8]  = max(f[0, 8], f[0, 4]+V_1) = max(0, 0+6) = 6
f[9]  = max(f[0, 9], f[0, 5]+V_1) = max(0, 0+6) = 6
f[10] = max(f[0, 10], f[0, 6]+V_1) = max(0, 0+6) = 6
