...
过拟合欠拟合的解决方法
ROC曲线如何构造  AUC是什么  为什么要使用ROC, AUC  
归一化方法有哪些  
...
1. 非线性最小二乘、高斯牛顿、kkt、活跃集、对偶、qr分解、稀疏矩阵求解   
2. 概率题，状态转移方程，期望  
3. 四元数插值（照着项目问的）  
4. c++基础  
5. self attention  
...
(Hello , 1)  (Hello , 1)  (Hello , 1)  (Hello , 1)   (Java , 1)  (Java , 1)  (C , 1)  (C++ , 1)  
